    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="商品分类Id" width="120">
          <template #default="scope">{{ convertGoodsTypeId(scope.row.goodsTypeId) }}</template>
        </el-table-column>
        ...
        <el-table-column align="left" label="商品创建人" prop="createId" width="120" />
        <el-table-column align="left" label="创建时间" width="180">
          <template #default="scope">{{ formatDate(scope.row.createTime) }}</template>
        </el-table-column>
        <el-table-column align="left" label="商品更新人" prop="updateId" width="120" />
        ...
        <el-table-column align="left" label="操作" min-width="120">
          <template #default="scope">
            ...
            <el-button type="primary" link icon="edit" class="table-button"
              @click="updateGoldGoodsFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
        <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="100px">
          ...
          <el-form-item label="商品名称:" prop="goodsName">
            <el-input v-model="formData.goodsName" :clearable="true" placeholder="请输入商品名称" />
          </el-form-item>
...
const getTableData = async () => {
  const table = await getGoldGoodsList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
