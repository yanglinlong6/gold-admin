        ...
        <el-table-column align="left" label="操作" min-width="120">
          <template #default="scope">
            ...
            <el-button
              ...
              icon="edit"
              class="table-button"
              @click="updateGoldShopFunc(scope.row)"
              >变更</el-button
            >
            <el-button
              type="primary"
      ...
      <el-scrollbar height="500px">
        ...
        >
          <el-form-item label="商品名称:" prop="goodsId">
            <el-input
              v-model.number="formData.goodsId"
              :clearable="true"
              placeholder="请输入商品名称"
            />
          </el-form-item>
          <el-form-item label="购买人:" prop="buyId">
            <el-input
              v-model.number="formData.buyId"
              :clearable="true"
              placeholder="请输入购买人"
            />
          </el-form-item>
...
const getTableData = async () => {
  const table = await getGoldShopList({
    page: page.value,
