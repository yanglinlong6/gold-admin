...
func Routers() *gin.Engine {
	...
	{
		orderManagerRouter := router.RouterGroupApp.OrderManager
		orderManagerRouter.InitGoldGoodsRouter(PrivateGroup)
		orderManagerRouter.InitGoldGoodsFileRouter(PrivateGroup)
		orderManagerRouter.InitGoldShopRouter(PrivateGroup)
	}
